...
export YARN_RESOURCEMANAGER_HEAPSIZE=6200
...
#
#
export YARN_RESOURCEMANAGER_OPTS=-Xmx6200m
...
# Default is the same as HADOOP_HEAPSIZE_MAX.
export YARN_NODEMANAGER_HEAPSIZE=6200
...
#
export YARN_NODEMANAGER_OPTS=-Xmx6200m
